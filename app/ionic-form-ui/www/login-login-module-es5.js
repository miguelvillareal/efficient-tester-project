(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function Y5(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_api_django_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../services/api-django.service */
      "ZqIr");

      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(authService, alertController, router, apiService, loadingController) {
                        ...
                        buttons: [{
                          ...
                          handler: function handler(alertData) {
                            ...
                            if (alertData.email) {
                              ...
                              _this.apiService.showLoading().then(function () {
                                _this.apiService.sendResetPasswordLink(alertData.email).subscribe(function () {
                                  _this.apiService.stopLoading();
                                });
                              });
                            } else {
                              //Display error message
                              _this.apiService.showError("Something went wrong");
                            }
                          }
                        }]
                      });
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      if (this.apiService.networkConnected) {
                        this.apiService.showLoading(); //let queryPath = "?email=" + this.registerCredentials.email + "&password=" + this.registerCredentials.password;

                        userToLogin = {
                          "email": this.registerCredentials.email,
                          "password": this.registerCredentials.password
                        };
                        this.authService.login(userToLogin).then(function (listUsers) {
                          ...
                          if (listUsers) {
                            ...
                            _this2.apiService.showError("Wrong login or password.");
                          }
                        });
                      } else {
