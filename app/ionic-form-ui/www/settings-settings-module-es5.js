  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["settings-settings-module"], {
    ...
    function Uncc(module, __webpack_exports__, __webpack_require__) {
      ...
      var SettingsPage = /*#__PURE__*/function () {
        function SettingsPage(apiService) {
        ...
        _createClass(SettingsPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {//console.log(myID);
          }
        }, {
          key: "updateEmail",
          value: function updateEmail() {
            var queryPath = src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_4__["myID"];
            var setUserInfo = {
              "email": this.userCredentials.email
            };
            this.apiService.infoUser(queryPath, setUserInfo).subscribe(function (myUser) {
              if (myUser) {
                console.log(myUser);
              }
            });
